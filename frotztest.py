...
class Frotz(object):
    ...
    def frotz_test(self, custom_parser=None):
    ...
    def save(self, filename=None):
        ...
        while True:
            ...
            elif char == b'?':  # Indicates an overwrite query
    ...
    def do_command_test(self, action):
        """ Write a command to the interpreter. """
        self.frotz.stdin.write(action.encode() + b'\n')
        self.frotz.stdin.flush()
